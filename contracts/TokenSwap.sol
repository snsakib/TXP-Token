...
contract TokenSwap is Pausable, ReentrancyGuard, Ownable {
    ...
    constructor(
        ...
        manualPrice[TXP] = 1e16;    // 0.01 USD per TXP  (1 USD = 100 TXP)
        manualPrice[YTC] = 1e18;    // 1.00 USD per YTC
        manualPrice[LCX] = 0.5e18;  // 0.50 USD per LCX
    }
    ...
    /// @notice Returns the manual price for a token (reverts if price is unset).
